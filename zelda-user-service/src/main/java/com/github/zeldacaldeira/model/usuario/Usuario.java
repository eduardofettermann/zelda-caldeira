...
public class Usuario implements UserDetails {
    ...
    public Usuario(AtualizacaoUsuario atualizacaoUsuario) {
        this.nome = atualizacaoUsuario.nome();
        this.idade = atualizacaoUsuario.idade();
        this.cargo = atualizacaoUsuario.cargo();
    }
